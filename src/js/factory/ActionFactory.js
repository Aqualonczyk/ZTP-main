...
if ( process.env.NODE_ENV === "development" ) {
    window.boss    = ( optLevel ) => generateBoss( gme.models.gameModel, optLevel );
    window.enemy   = () => generateSingle( gme.models.gameModel );
    window.powerUp = () => createEnergyPowerUp( gme.models.gameModel );
    window.weapon  = () => createWeapon( gme.models.gameModel );
}
